<?php	
	...
	$q_student = $conn->query("SELECT * FROM `student` WHERE student_id = '$_REQUEST[student_id]'") or die($conn->error);
	$f_student = $q_student->fetch_array();
?>
<input type = "hidden" id = "student_id" value = "<?php echo $f_student['student_id']?>"/>
<img style = "margin:20px;" class = "pull-left" src = "<?php if($f_student['photo'] == "default.png"){echo "http://sereneooi-bucket.s3-website-us-east-1.amazonaws.com/images/".$f_student['photo'];}else{echo "../upload/".$f_student['photo'];}?>" height = "150px" width = "150px"/>
