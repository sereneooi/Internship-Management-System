<div id = "aboutus" class = "tab-pane fade">
	<div class = "alert" style='background-color: #0080d2;color:white;'><center><h3>VISION</h3></center></div>
	...
	<br />
	<div class = "alert" style='background-color: #0080d2;color:white;'><center><h3>MISSION</h3></center></div>
	...
	<br />
	<div class = "alert" style='background-color: #0080d2;color:white;'><center><h3>OBJECTIVE</h3></center></div>
	<ol>
