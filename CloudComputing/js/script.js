...
/*	Student Login*/
	$(document).on('click', '#student_login' ,function(){
		if($('#student_id').val() == ""){
			...
			+ '<center><img src = "http://sereneooi-bucket.s3-website-us-east-1.amazonaws.com/images/loader.gif" height = "50px"/></center>'
			);
...
/*   Administrator Login  */	
	$('#login').click(function(){
		$loading = $('<center><img src = "http://sereneooi-bucket.s3-website-us-east-1.amazonaws.com/images/loading.gif" height = "10px"/></center>');
		$error.remove();
		$error1.remove();
